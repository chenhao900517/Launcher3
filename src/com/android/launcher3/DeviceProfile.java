...
public class DeviceProfile {
    ...
    public void layout(Launcher launcher) {
        ...
        workspace.setPadding(20, 0, 20, padding.bottom);
        ...
        if (pageIndicator != null) {
            if (hasVerticalBarLayout) {
                ...
                // ROCO_ShiYouHui modfiy for display pageIndicator when desktop landscape  @ 2015-11-17 >>>
